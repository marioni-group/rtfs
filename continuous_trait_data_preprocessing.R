...
#gs10kTargets <- readRDS('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/continuous_traits/data/GS10k_Targets.rds')

gs20kTargets <- readRDS('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/GS20k_Targets.rds')

# phenotypes <- readRDS('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/GS_pheno_resids_20k.rds')
phenotypes1 <- readRDS('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/GS_pheno_resids_20k_w1.rds')
phenotypes3 <- readRDS('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/GS_pheno_resids_20k_w3.rds')
phenotypes4 <- readRDS('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/GS_pheno_resids_20k_w4.rds')
...
methylW1 <- readRDS('/Cluster_Filespace/Marioni_Group/GS/GS_methylation/norm_mvals_5087.rds')
...
methylW3 <- readRDS('/Cluster_Filespace/Marioni_Group/GS/GS_methylation/wave3-final/w3.mvals.rds')
...
methylW4 <- readRDS('/Cluster_Filespace/Marioni_Group/GS/GS_methylation/wave4/w4-mvals.rds')
...
saveRDS(phenotypesW1, '~/rtfs_20k/phenotypesW1.rds')
print('Saving phenotypesW3.')
saveRDS(phenotypesW3, '~/rtfs_20k/phenotypesW3.rds')
print('Saving phenotypesW4.')
saveRDS(phenotypesW4, '~/rtfs_20k/phenotypesW4.rds')

print('Saving methylW1.')
saveRDS(methylW1, '~/rtfs_20k/methylW1.rds')
print('Saving methylW3.')
saveRDS(methylW3, '~/rtfs_20k/methylW3.rds')
print('Saving methylW4.')
saveRDS(methylW4, '~/rtfs_20k/methylW4.rds')

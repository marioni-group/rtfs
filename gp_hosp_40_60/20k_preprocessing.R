...
if (censoring == "oct_2020") {
  coxTable <- read.csv('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/gp_hosp_40_60/t2d_cox_oct_2020_censoring_date.csv')[, c('Sample_Name', 'Event', 'tte')]
} else if (censoring == "apr_2022") {
  coxTable <- read.csv('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/gp_hosp_40_60/t2d_cox_apr_2022_censoring_date.csv')[, c('Sample_Name', 'Event', 'tte')]
} else {
...
writeLines(paste0('Number of individuals in test Cox table after removing NA time_to_event <= 0 = ', nrow(testCoxTable)))
...
writeLines('Wave 4')
saveRDS(w4CoxTable, paste0('/Local_Scratch/Yipeng/w4CoxTable_', censoring, '.rds'))
# saveRDS(w4Methyl, paste0('/Local_Scratch/Yipeng/w4Methyl_', censoring, '.rds'))

writeLines('Wave 3')
saveRDS(w3CoxTable, paste0('/Local_Scratch/Yipeng/w3CoxTable_', censoring, '.rds'))
# saveRDS(w3Methyl, paste0('/Local_Scratch/Yipeng/w3Methyl_', censoring, '.rds'))

writeLines('Wave 1')
saveRDS(w1CoxTable, paste0('/Local_Scratch/Yipeng/w1CoxTable_', censoring, '.rds'))
# saveRDS(w1Methyl, paste0('/Local_Scratch/Yipeng/w1Methyl_', censoring, '.rds'))

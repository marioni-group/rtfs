...
rtfsTestResults <- readRDS('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/gp_hosp_40_60/scripts_20230221/results/methylpiper_logs/output_2023_05_11_00_44_56/testResults.rds')
ewas76TestResults <- readRDS('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/gp_hosp_40_60/scripts_20230221/results/methylpiper_logs/output_2023_02_27_10_26_05/testResults.rds')
...
pdf('rtfs_metrics_at_different_thresholds_w4_filtered_by_family.pdf', width = 8, height = 8)
par(mfrow = c(2,2))
...
# points(thresholds, ewas76TruePositives, col = 'brown', pch='*')
...
# points(thresholds, ewas76FalseNegatives, col = 'brown', pch='*')
...
# points(thresholds, ewas76FalsePositives, col = 'brown', pch='*')
...
# points(thresholds, ewas76TrueNegatives, col = 'brown', pch='*')

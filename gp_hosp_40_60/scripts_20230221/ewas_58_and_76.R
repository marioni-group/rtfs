...
prevalentCpGs <- read.csv('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/gp_hosp_40_60/type_2_diabetes_ewas_catalog_20230220.tsv', sep = '\t')$cpg
incidentCpGs <- read.csv('/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/rtfs_20k/gp_hosp_40_60/ewas_76_cpgs.csv')$cpg

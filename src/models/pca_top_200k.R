...
initLogs(config$methylpiper_logs_path, note = 'Cox elastic-net EpiScore predictor, CpGs filtered to top 200k by variance. PCA applied, keeping top PCs that together explain 95% of the training set variance. Trained on w3 only')

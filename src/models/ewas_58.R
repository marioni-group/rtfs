...
initLogs(config$methylpiper_logs_path, note = 'Cox elastic-net EpiScore predictor, CpGs filtered to prevalent T2D EWAS hits. Trained on w3 only')

set.seed(42)

cpgs <- read.csv(here::here("resources", "type_2_diabetes_ewas_catalog_20230220.tsv"), sep = '\t')$cpg
